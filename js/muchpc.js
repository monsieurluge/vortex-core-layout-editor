...
const keyDef = {
    ...
    1: { name: 'Error Roll Over', legend: '<span style="font-size: 80%;">x01</span>' },
    2: { name: 'POST Fail', legend: '<span style="font-size: 80%;">x02</span>' },
    3: { name: 'Error Undefined', legend: '<span style="font-size: 80%;">x03</span>' },
    4: { name: 'A', legend: 'A' },
    5: { name: 'B', legend: 'B' },
    6: { name: 'C', legend: 'C' },
    7: { name: 'D', legend: 'D' },
    ...
    66: { name: 'Power', legend: '<span style="font-size: 80%;">x66</span>' },
    ...
    74: { name: 'Execute', legend: '<span style="font-size: 80%;">x74</span>' },
    75: { name: 'Help', legend: '<span style="font-size: 80%;">x75</span>' },
    76: { name: 'Menu', legend: '<span style="font-size: 80%;">x76</span>' },
    77: { name: 'Select', legend: '<span style="font-size: 80%;">x77</span>' },
    78: { name: 'Stop', legend: '<span style="font-size: 80%;">x78</span>' },
    79: { name: 'Again', legend: '<span style="font-size: 80%;">x79</span>' },
    '7A': { name: 'Undo', legend: '<span style="font-size: 80%;">x7A</span>' },
    '7B': { name: 'Cut', legend: '<span style="font-size: 80%;">x7B</span>' },
    '7C': { name: 'Copy', legend: '<span style="font-size: 80%;">x7C</span>' },
    '7D': { name: 'Paste', legend: '<span style="font-size: 80%;">x7D</span>' },
    '7E': { name: 'Find', legend: '<span style="font-size: 80%;">x7E</span>' },
    '7F': { name: 'Mute', legend: '<span style="font-size: 80%;">x7F</span>' },
    80: { name: 'Volume Up', legend: '<span style="font-size: 80%;">x80</span>' },
    81: { name: 'Volume Down', legend: '<span style="font-size: 80%;">x81</span>' },
    82: { name: 'Locking CapsLock', legend: '<span style="font-size: 80%;">x82</span>' },
    83: { name: 'Locking NumLock', legend: '<span style="font-size: 80%;">x83</span>' },
    84: { name: 'Locking ScrollLock', legend: '<span style="font-size: 80%;">x84</span>' },
    85: { name: 'Comma', legend: '<span style="font-size: 80%;">x85</span>' },
    86: { name: 'Equal Sign', legend: '<span style="font-size: 80%;">x86</span>' },
    ...
    99: { name: 'AltErase', legend: '<span style="font-size: 80%;">x99</span>' },
    '9A': { name: 'SysReq', legend: '<span style="font-size: 80%;">x9A</span>' },
    '9B': { name: 'Cancel', legend: '<span style="font-size: 80%;">x9B</span>' },
    '9C': { name: 'Clear', legend: '<span style="font-size: 80%;">x9C</span>' },
    '9D': { name: 'Prior', legend: '<span style="font-size: 80%;">x9D</span>' },
    '9E': { name: 'Return', legend: '<span style="font-size: 80%;">x9E</span>' },
    '9F': { name: 'Separator', legend: '<span style="font-size: 80%;">x9F</span>' },
    A0: { name: 'Out', legend: '<span style="font-size: 80%;">xA0</span>' },
    A1: { name: 'Oper', legend: '<span style="font-size: 80%;">xA1</span>' },
    A2: { name: 'Clear / Again', legend: '<span style="font-size: 80%;">xA2</span>' },
    A3: { name: 'CrSel / Props', legend: '<span style="font-size: 80%;">xA3</span>' },
    A4: { name: 'ExSel', legend: '<span style="font-size: 80%;">xA4</span>' },
    ...
    // Vortex Specific
    E9: { name: 'ACPI PD', legend: '<span style="font-size: 80%;">xE9</span>' },
    EA: { name: 'ACPI Sleep', legend: '<span style="font-size: 80%;">xEA</span>' },
    EB: { name: 'ACPI Wake', legend: '<span style="font-size: 80%;">xEB</span>' },
    EC: { name: 'Media Sel', legend: '<span style="font-size: 80%;">xEC</span>' },
...
const fullKeyboard = [
    ...
    [FK('39', '1x1_75'), FK('4'), FK('16'), FK('7'), FK('9'), FK('A'), FK('B'), FK('D'), FK('E'), FK('F'), FK('33'), FK('34'), FK('28', '1x2_25'), FK(null, '1x4'), FK('5C'), FK('5D'), FK('5E'), FK(null)],
    [
        FK('E1', '1x2_25'),
        FK('1D'),
        FK('1B'),
...
function FK(keyCode = null, type = '1x1') {
    // FullKeyboard Key
...
var app = new Vue({
    ...
    computed: {
        ...
        shortcuts: function () {
            ...
            return {
                'Remove all RGB controls': function () {
                    ...
                    UIkit.notification('<i class="fas fa-check"></i> RGB control removed.', {
                        pos: 'bottom-right',
                        status: 'success',
                    }).$el.classList.add('uk-box-shadow-large');
                },
                'Clear Fn layer': function () {
                    _run_through_rows(function (k, p) {
                        k.profiles[p].fn = '0';
                    });
                    UIkit.notification('<i class="fas fa-check"></i> Fn layer cleared.', {
                        pos: 'bottom-right',
                        status: 'success',
                    }).$el.classList.add('uk-box-shadow-large');
                },
                'Clear Pn layer': function () {
                    ...
                    UIkit.notification('<i class="fas fa-check"></i> Pn layer cleared.', {
                        pos: 'bottom-right',
                        status: 'success',
                    }).$el.classList.add('uk-box-shadow-large');
                },
                'Clear Fn1 layer': function () {
                    ...
                    UIkit.notification('<i class="fas fa-check"></i> Fn1 layer cleared.', {
                        pos: 'bottom-right',
                        status: 'success',
                    }).$el.classList.add('uk-box-shadow-large');
                },
        ...
        memoryUsage: function () {
            ...
            // Always has 12 functionSet due to the default bind fix
            const functionSetCount = profileCount * 3;
            let dataSize = functionSetCount * 16;
                ...
                for (var k in row) {
                    ...
                    for (var i = 0; i < profileCount; i++) {
                        ...
                        if (profile.bind != 'FN' && profile.bind != 'FN1' && profile.bind != 'PN') {
                            // Key Change & macros
                            // helpers
                            var countKey = function (bind_code, default_code) {
                            ...
                            var countMacro = function (macros, key_code, macro_id, layer) {
                                var bind_macro = macros.filter(function (m) {
                                    return m.id == macro_id;
                                })[0];
                                if (!bind_macro) return;
                                dataSize += bind_macro.events.length * 4 + 4;
                                dataSize += 24;
                            };

                            // main layer
                            if (profile.bind == 'Macro') countMacro(this.macros, key.code, profile.bind_macro, 'INIT');
                            else countKey(profile.bind, key.code);
                            // pn layer
                            if (profile.pn == 'Macro') countMacro(this.macros, key.code, profile.pn_macro, 'PN');
                            else countKey(profile.pn, profile.default_pn);
                            // fn layer
                            if (profile.fn == 'Macro') countMacro(this.macros, key.code, profile.fn_macro, 'FN');
                            else countKey(profile.fn, profile.default_fn);
                            // fn1 layer
                            if (profile.fn1 == 'Macro') countMacro(this.macros, key.code, profile.fn1_macro, 'FN1');
                            else countKey(profile.fn1, profile.default_fn1);
                        }
                    }
                }
            }
    ...
    methods: {
        openFile: function (callback) {
            ...
            this.fileListener = function (t) {
                callback(t.target.files);
                t.target.value = '';
            };
        ...
        generateOld: function () {
            try {
                var blob = new Blob([this.convertToBytesOld(this.rowsToMPCData)], {
                    type: 'octet/stream',
                });
                UIkit.notification('<i class="fas fa-download"></i> Layout file generated.', {
                    pos: 'bottom-right',
                    status: 'success',
                }).$el.classList.add('uk-box-shadow-large');
        ...
        generate: function () {
            try {
                var blob = new Blob([this.convertToBytes(this.rowsToMPCData)], {
                    type: 'octet/stream',
                });
                UIkit.notification('<i class="fas fa-download"></i> Layout file generated.', {
                    pos: 'bottom-right',
        ...
        importMacros: function (file) {
            ...
            reader.onload = function (e) {
                try {
                    ...
                    if (obj.macros && obj.macros.length > 0) {
                        ...
                        UIkit.notification('<i class="fas fa-check"></i> Macros imported.', {
                            pos: 'bottom-right',
                            status: 'success',
                        }).$el.classList.add('uk-box-shadow-large');
                    } else {
                        UIkit.notification('<i class="fas fa-check"></i> Layout file contains no macro.', {
                            pos: 'bottom-right',
                            status: 'warning',
                        }).$el.classList.add('uk-box-shadow-large');
                    }
                    ...
                    console.error(err);
                    UIkit.notification('<i class="fas fa-exclamation-circle"></i> Failed to open.', {
                        pos: 'bottom-right',
                        status: 'danger',
                    }).$el.classList.add('uk-box-shadow-large');
                }
            ...
            try {
                ...
                console.error(err);
                UIkit.notification('<i class="fas fa-exclamation-circle"></i> Can not open this file.', {
                    pos: 'bottom-right',
                    status: 'warning',
                }).$el.classList.add('uk-box-shadow-large');
            }
        ...
        importFile: function (file) {
            ...
            reader.onload = function (e) {
                try {
                    ...
                    UIkit.notification('<i class="fas fa-check"></i> Layout file opened.', {
                        pos: 'bottom-right',
                        status: 'success',
                    }).$el.classList.add('uk-box-shadow-large');
                } catch (err) {
        ...
        exportFile: function () {
            ...
            UIkit.notification('<i class="fas fa-download"></i> Download started.', {
                pos: 'bottom-right',
                status: 'success',
            }).$el.classList.add('uk-box-shadow-large');
        ...
        convertToBytes: function (mpc) {
            ...
            const grow = (offset, fill = 0x00) => {
                while (buffer.length < offset) {
                    buffer.push(fill);
                }
            };
            const set1Byte = (offset, n, num) => {
                grow(offset + n + 1);
                let bytes = num & 0xff;
                buffer[offset + n] = bytes;
            };

            const set2Byte = (offset, n, num) => {
                grow(offset + n + 2);
                let bytes = num & 0xffff;
                buffer[offset + n] = bytes & 0xff;
                buffer[offset + n + 1] = (bytes & 0xff00) >> 8;
            };

            const set4Byte = (offset, n, num) => {
                grow(offset + n + 4);
                let bytes = num & 0xffffffff;
                buffer[offset + n] = bytes & 0xff;
                buffer[offset + n + 1] = (bytes & 0xff00) >> 8;
                buffer[offset + n + 2] = (bytes & 0xff0000) >> 16;
                buffer[offset + n + 3] = (bytes & 0xff000000) >> 24;
            };

            const setKeyItem = (offset, profile, dataPosition) => {
                set1Byte(offset, 0, 0); // type
                set1Byte(offset, 1, profile); // profileIndex
                set2Byte(offset, 2, 0); // macroIndex
                set4Byte(offset, 4, dataPosition); // dataPosition
            };

            const setEventItem = (offset, profile, macroIndex, dataPosition) => {
                set1Byte(offset, 0, 1); // type
                set1Byte(offset, 1, profile); // profileIndex
                set2Byte(offset, 2, macroIndex); // macroIndex
                set4Byte(offset, 4, dataPosition); // dataPosition
            };
            ...
            set4Byte(0, 0, 0x49465943); // CYFI
            set2Byte(4, 0, 0x0000); // revision
            set2Byte(6, 0, itemSize);

            let itemOffset = 8;
            let dataOffset = itemOffset + itemSize * 8;

            const LAYER_ID = { INIT: 0, FN: 1, FN1: 2, PN: 3 };
            const MODIFIER_ID = { FN: 0x94, FN1: 0x95, PN: 0x96 };
            ...
            const processProfile = (profile) => {
                ...
                for (const data of functionSet) {
                    // item
                    setKeyItem(itemOffset, data.profileIndex, dataOffset);
                    itemOffset += 8;

                    // data
                    set1Byte(dataOffset, 0, 0x02);
                    set1Byte(dataOffset, 1, MODIFIER_ID[data.key]);
                    set2Byte(dataOffset, 2, data.ktm.length);
                    for (let i = 0; i < 4; ++i) {
                        if (i < data.ktm.length) {
                            set1Byte(dataOffset, 4 + i, data.ktm[i]);
                        } else {
                            set1Byte(dataOffset, 4 + i, 0x00);
                        }
                    }
                    dataOffset += 8;
                }
                ...
                for (const data of keyChanges) {
                    ...
                    // data
                    set1Byte(dataOffset, 0, 0x02);
                    set1Byte(dataOffset, 1, 0x20);
                    set1Byte(dataOffset, 2, parseInt(data.sourceKey, 16));
                    set1Byte(dataOffset, 3, LAYER_ID[data.sourceLayer]);
                    set1Byte(dataOffset, 4, parseInt(data.targetKey, 16));
                    set1Byte(dataOffset, 5, LAYER_ID[data.targetLayer]);
                    set2Byte(dataOffset, 6, 0x0000);
                    dataOffset += 8;
                }

                const macros = mpc.macro.filter((v) => v.profileIndex == profile);
                let macroIndex = 0;
                let macroOffset = dataOffset + macros.length * 8 + 4;
                for (const data of macros) {
                    ...
                    // data
                    set1Byte(dataOffset, 0, 0x02);
                    set1Byte(dataOffset, 1, 0x18);
                    set2Byte(dataOffset, 2, macroIndex);
                    set1Byte(dataOffset, 4, parseInt(data.sourceKey, 16));
                    set1Byte(dataOffset, 5, (data.macroType << 5) | 0x1c | LAYER_ID[data.sourceLayer]);
                    set2Byte(dataOffset, 6, parseInt(data.macroRepeat));
                    dataOffset += 8;

                    // event item
                    setEventItem(itemOffset, data.profileIndex, macroIndex, macroOffset);
                    itemOffset += 8;
                    ...
                    for (const event of data.macro) {
                        ...
                        set1Byte(macroOffset, 0, parseInt(event.key, 16));
                        set1Byte(macroOffset, 1, ((2 - event.event) << 5) | 0x1c | LAYER_ID[event.layer]);
                        set2Byte(macroOffset, 2, Math.floor(timer < 16383 ? timer / 0.5 - 1 : timer / 512 - 1 + 32768));
                        macroOffset += 4;
                    }
                    set1Byte(macroOffset, 0, 0x00);
                    set1Byte(macroOffset, 1, 0xfc);
                    set2Byte(macroOffset, 2, 0x0000);
                    macroOffset += 4;
                    macroIndex += 1;
                }
                dataOffset = macroOffset + 8;
                grow(dataOffset);
            };
